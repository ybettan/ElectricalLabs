...
#   set_location_assignment  PIN_P26 -to EXT_CLOCK						;# 	External clock (Only Optional) 
   ...
   set_location_assignment	PIN_G26  -to reset  ;# KEY0				;#	Global reset to FPGA
...
##   set_location_assignment PIN_AE13  -to listen  ;# LEDR15			;#	Used for indication of slide switch #15
   set_location_assignment PIN_AE12  -to make  ;# LEDR16			;#	Used for indication of slide switch #16
   set_location_assignment PIN_AD12  -to break  ;# LEDR17			;#	Used for indication of slide switch #17
